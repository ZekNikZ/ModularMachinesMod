...
public class ModNodeComponents {
    ...
    public static final RegistryObject<NodeComponentType<SimpleTextNodeComponent>> SIMPLE_TEXT = NODE_COMPONENTS.register("simple_text", () -> NodeComponentType.Builder.of(SimpleTextNodeComponent::new, SimpleTextNodeComponent::new).build());
    public static final RegistryObject<NodeComponentType<PinComponent>> PINS = NODE_COMPONENTS.register("pins", () -> NodeComponentType.Builder.of(PinComponent::new, PinComponent::new).build());
