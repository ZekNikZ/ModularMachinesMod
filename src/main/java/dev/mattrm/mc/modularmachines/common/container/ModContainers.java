...
public class ModContainers {
    ...
    public static final RegistryObject<MenuType<ControllerContainer>> CONTROLLER = CONTAINERS.register("controller", () -> IForgeMenuType.create(
        (windowId, inv, data) -> new ControllerContainer(windowId, data.readBlockPos(), inv, inv.player)
    ));
